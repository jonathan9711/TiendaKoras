...
if (isset($_GET["fechaInicial"]))
{
    ...
    $itemUsuario = "almacen";
    $itemVenta = "id_almacen";
    $valor = $_SESSION["almacen"];
    $ventas = controladorVentas::ctrRangoFechasVentas($fechaInicial,$fechaFin,$valor);
    $usuarios = ControladorUsuarios::ctrMostrarUsuariosAlmacen($itemUsuario,$valor);
}
else
{
  $itemUsuario = "almacen";
  $itemVenta = "id_almacen";
  $valor = $_SESSION["almacen"];
  $ventas = controladorVentas::ctrMostrarVentasAlmacen($itemVenta,$valor);
  $usuarios = ControladorUsuarios::ctrMostrarUsuariosAlmacen($itemUsuario,$valor);
}
  ...
  foreach ($ventas as $key => $valueVentas) 
  {
    ...
    {
      if($valueUsuarios["id"] == $valueVentas["id_usuario"])
      {
