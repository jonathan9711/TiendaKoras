        ...
        <div style="width: 30%;display: inline-block;vertical-align: middle;">
          ...
          <div class="input-group">
            <?php
              ...
              echo '<input type="hidden" id="perfil" value="'.$perfil.'">';
              if ($perfil == "Gerente General")
              {
                  $item = null;
                  $valor = null;
                  $respuesta = ControladorAlmacen::ctrMostrarAlmacen($item,$valor);
                  echo ' <select class="form-control input-lg almacenInventario" id="almacen">';
              ...
              else
              {
                  ...
                  $valor = null;
                  $respuesta = ControladorAlmacen::ctrMostrarAlmacen($item,$valor);
                  echo ' <select class="form-control input-lg almacenInventarioRoot" id="almacen">';
                  foreach ($respuesta as $key => $value)
                  {
                      echo '<option value="'.$value["id_almacen"].'">'.$value["nombre"].'</option>';
                  }
                  ...
                  echo '<input type="hidden" id="root" value="'.$_SESSION["almacen"].'">';
              }
            ?>
          </div> 
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <?php
            ...
            $agregarInventario = new ControladorInventario();
            $agregarInventario -> ctrSalidaProducto();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                      ...
                      else
                      {
                          echo '<input type="text" class="form-control input-lg" id="almacenAgregar1" readonly>
                                <input type="hidden" name="almacenAgregar" id="almacenAgregar">';
                      }
                  ?>
          ...
          <?php
            $agregarUnaExistencia = new ControladorInventario();
            $agregarUnaExistencia -> ctrAgregarExistenciaAlmacen();
          ?>
